...
function calcX(x1,x2,y1,y2){
    if(y1 < y2) {
        return x1 + Math.cos(((p/180)*Math.PI)-Math.acos((x1-x2)/Math.sqrt(Math.pow(x1-x2,2)+Math.pow(y2-y1,2))))*Math.sqrt(Math.pow(x1-x2,2)+Math.pow(y2-y1,2));
    }
    else{
        if(x1 > x2){
            return x1 - Math.sin(((p/180)*Math.PI)-Math.acos((y1-y2)/Math.sqrt(Math.pow(y1-y2,2)+Math.pow(x1-x2,2))))*Math.sqrt(Math.pow(x1-x2,2)+Math.pow(y1-y2,2));
        //ymshi
        }else{
            return x1 - Math.cos(((p/180)*Math.PI)-Math.acos((x2-x1)/Math.sqrt(Math.pow(y1-y2,2)+Math.pow(x2-x1,2))))*Math.sqrt(Math.pow(y1-y2,2)+Math.pow(x2-x1,2));
        }
    }
}
function calcY(x1,x2,y1,y2){
    if(y1 < y2) {
        return y1 + Math.sin(((p/180)*Math.PI)-Math.acos((x1-x2)/Math.sqrt(Math.pow(x1-x2,2)+Math.pow(y2-y1,2))))*Math.sqrt(Math.pow(x1-x2,2)+Math.pow(y2-y1,2));   
    }
    else{
        if(x1 > x2){
            return y1 + Math.cos(((p/180)*Math.PI)-Math.acos((y1-y2)/Math.sqrt(Math.pow(y1-y2,2)+Math.pow(x1-x2,2))))*Math.sqrt(Math.pow(x1-x2,2)+Math.pow(y2-y1,2));
        //ymshi
        }else{
            return y1 - Math.sin(((p/180)*Math.PI)-Math.acos((x2-x1)/Math.sqrt(Math.pow(y1-y2,2)+Math.pow(x2-x1,2))))*Math.sqrt(Math.pow(y1-y2,2)+Math.pow(x2-x1,2));
        } 
    }
}
