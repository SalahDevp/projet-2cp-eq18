    ...
    <div>
       <h1 className='underline decoration-solid text-nav font-black text-3xl'>4. Symétrique d'un cercle:</h1>
             ...
             <div className='ml-6 mt-4'>
                 <p className='  text-xl font-normal' >Le symétrique d’un cercle par rapport à une droite <span className='text-ltr-cr'>(d)</span> est <span className='text-ltr-cr'>un cercle de même rayon </span>  et dont le centre est <span className='text-ltr-cr'>le symétrique</span>  du centre du premier cercle.</p>
