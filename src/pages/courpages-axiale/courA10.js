  ...
  return (
    <div>
       ...
       <div className='ml-6 mt-2'>
            <p className='text-xl font-medium'>1) Dans le cas où la droite <span className='text-ltr-cr'>(AB)</span> et la droite <span className='text-ltr-cr'>(d)</span> sont parallèles</p>
            <div className='mt-2 flex justify-center'>
                 <img className='h-48 w-96' src={img1} alt="" />           
             </div>
            <ul className='ml-10 text-xl font-normal list-disc'>
                <li>La droite <span className='text-ltr-cr'>(AB)</span> et la droite <span className='text-ltr-cr'>(A’B’)</span> sont aussi parallèles.</li>
            </ul>
        </div>
       <div className='ml-6 mt-2'>
            <p className='text-xl font-medium'>1) Dans le cas où la droite <span className='text-ltr-cr'>(AB) </span>et la droite <span className='text-ltr-cr'>(d)</span> sont parallèles</p>
