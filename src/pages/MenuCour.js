  ...
  return (
    <div className="bg-beige relative h-screen w-screen">
     ...
     <Sortir />
      ...
      >
        <div
          className="-mt-20 px-4 pt-1 pb-16 z-50 bg-whiteL  overflow-hidden border-2 border-jeune w-64 h-80  rounded-xl cursor-pointer"
        ...
        <div
          className=" mt-32 px-6 pt-1 pb-20 z-50 bg-whiteL  overflow-hidden border-2 border-jeune w-64 h-80  rounded-xl cursor-pointer"
