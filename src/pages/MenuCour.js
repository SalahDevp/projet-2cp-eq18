 ...
 <Nav pathAvant="/NMenu" />
        ...
        <div  className=" absolute  top-96 left-1/2 -translate-x-1/2 -translate-y-1/2  
         h-98 w-99 flex items-start   justify-between " >  
            ...
            <div className="px-4 pt-1 pb-16 z-50 bg-whiteL  overflow-hidden border-2 border-jeune w-56 h-80  rounded-xl cursor-pointer" onClick={handleCentralMode}>
                  <p className=" text-xl text-center  ">Symétrie <br />centrale</p>
                <img className="pt-4  h-full w-full  " src={img1} alt="not found" />
            </div>

           
           <div className=" mt-28 px-6 pt-1 pb-20 z-50 bg-whiteL  overflow-hidden border-2 border-jeune w-56 h-80  rounded-xl cursor-pointer" onClick={handleAxialeMode}>
             <p className=" text-xl text-center">Symétrie<br /> axiale</p>
