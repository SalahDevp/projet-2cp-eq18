    ...
    <div>
          ...
          <div className='ml-6 mt-2'>
                    ...
                    <ul className='list-disc ml-10 mt-2 font-normal text-xl'>
                        <li>le centre <span className='text-ltr-cr'>A’</span> est le symétrique du centre <span className='text-ltr-cr'>A</span> par <span className='text-ltr-cr'>O</span>.</li>
                        <li>les rayons des deux cercles sont égales <span className='text-ltr-cr'>AB = A’B’</span> .</li>
